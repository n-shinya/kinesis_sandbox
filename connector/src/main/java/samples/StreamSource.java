...
public class StreamSource implements Runnable {
     ...
     * 
     * @param config
     *        Configuration to determine which stream to put records to and get {@link com.amazonaws.auth.AWSCredentialsProvider}
     * @param inputFile
    ...
    protected void processInputStream(InputStream inputStream, int iteration) throws IOException {
        try (BufferedReader br = new BufferedReader(new InputStreamReader(inputStream))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                putRecordRequest.setPartitionKey(kinesisMessageModel.getId());
