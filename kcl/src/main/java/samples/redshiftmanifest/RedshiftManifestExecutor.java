...
public class RedshiftManifestExecutor extends KinesisConnectorExecutor<String, String> {
    ...
    /**
     * Main method to run the Amazon Redshift manifest copy sample. Runs both the {@link samples.redshiftmanifest.S3ManifestExecutor} and
     * {@link samples.redshiftmanifest.RedshiftManifestExecutor}
     * 
     * @param args
     */
