...
/**
 * The Pipeline used by the {@link samples.redshiftmanifest.RedshiftManifestExecutor} in the Amazon Redshift manifest sample.
 * Processes Amazon S3 file name records in String format. Uses:
 * <ul>
 * <li>{@link com.amazonaws.services.kinesis.connectors.redshift.RedshiftManifestEmitter}</li>
 * <li>{@link com.amazonaws.services.kinesis.connectors.impl.BasicMemoryBuffer}</li>
 * <li>{@link com.amazonaws.services.kinesis.connectors.impl.StringToByteArrayTransformer}</li>
