...
/**
 * The Pipeline used by the {@link samples.redshiftmanifest.S3ManifestExecutor} in the Amazon Redshift manifest sample. Processes
 * KinesisMessageModel records in JSON String format and outputs Amazon S3 file name records in String
 * format. Uses:
 * <ul>
 * <li>{@link com.amazonaws.services.kinesis.connectors.s3.S3ManifestEmitter}</li>
 * <li>{@link com.amazonaws.services.kinesis.connectors.impl.BasicMemoryBuffer}</li>
 * <li>{@link samples.redshiftbasic.KinesisMessageModelRedshiftTransformer}</li>
